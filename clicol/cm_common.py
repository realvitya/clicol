...
def init(ct):
  ...
  cmap=[
      ...
      #Traffic
      ["","",re.compile(BOS+r"([0-9]+ )(bits/sec)\b",flags=re.M),ct['trafficrate']+r"\1"+ct['default']+r"\2",CONT],
      ...
      #IPv4 address
      ["","",re.compile(BOS+r"([^a-zA-Z-](?:[0-9]{1,3}\.){3}[0-9]{1,3})",flags=re.M), ct['address']+r"\1"+ct['default'],CONT],
      #IPv6 address
